...
fig = plt.figure(num=1, figsize=(256, 16))
...
display.waveshow(s_show[start_:start_+sr], sr, alpha=0.8, x_axis='s', offset=0.5)
...
print("offset:", start_ - best_offset)
...
# display.waveshow(s_show1[best_offset:best_offset+sr], sr, alpha=0.8, x_axis='s', offset=0.5)
#
# fig.add_subplot(3, 1, 3)
# display.waveshow(ret[:sr], sr, alpha=0.8, x_axis='s', offset=0.5)
#
