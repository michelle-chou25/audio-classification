...
if training_data:
    paths_ = {
        'OK': r'E:\workspace\audio_relay\dataset\one_mic\train\OK',
        'NG': r'E:\workspace\audio_relay\dataset\one_mic\train\NG'
    }
else:
    paths_ = {
        'OK': r'E:\workspace\audio_relay\dataset\one_mic\val\OK',
        'NG': r'E:\workspace\audio_relay\dataset\one_mic\val\NG'
    }
    ...
    for one_folder in folders:
        ...
        for one in files:
            ...
            if class_id[ret.argmax()] != k:
                ...
                # shutil.copy(one_file_path, rf'../need_test/error_{k}/{one}')
