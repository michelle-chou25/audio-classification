...
import os
import shutil
from dataloaders.audioset_dataset import AudiosetDataset
from models.Models import MBNet, EffNetAttention, ResNetAttention
...
if __name__ == '__main__':
    ...
    try:
        ...
        print(f"rmtree {save_path} ERROR:", e)

    _file_wav_mode = False
    tensorboard=True
    # I/O args
    parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument("--data-train", type=str, default='../wz_relay/wz_relay_train.json', help="training data json")
    parser.add_argument("--data-val", type=str, default='../wz_relay/wz_relay_val.json', help="validation data json")
